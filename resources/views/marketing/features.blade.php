...
<section class="gradient-hero gradient-mesh py-24 lg:py-32 border-b border-border-light relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <p class="text-text-secondary text-xl lg:text-2xl mt-8 max-w-2xl mx-auto font-medium leading-relaxed">
            El sistema más completo del mercado argentino. Liquidaciones, portal del propietario, IA y soporte en tiempo real — todo en una sola plataforma.
        </p>
    </div>
</section>
...
<section id="liquidaciones" class="py-20 lg:py-28 bg-white scroll-mt-28">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
        ...
        <div class="mb-12">
            <span class="inline-block px-3 py-1 bg-primary/10 text-primary font-black text-xs uppercase tracking-[0.2em] rounded-full mb-4">Finanzas</span>
            <h2 class="text-3xl lg:text-4xl font-black text-text-primary mb-2 tracking-tight">Finanzas & Liquidaciones</h2>
            <p class="text-text-secondary font-medium text-lg">El core del negocio: automatizá todo el ciclo financiero del consorcio.</p>
        </div>
        <div class="grid md:grid-cols-3 gap-8">
            {{-- 1. Liquidaciones --}}
            <div class="bg-bg rounded-2xl border border-border-light p-8 hover:shadow-xl hover:border-primary/30 transition-all duration-500 group">
...
<section id="propietarios" class="py-20 lg:py-28 bg-slate-50 scroll-mt-28">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
         ...
         :class="shown ? 'animate-section-reveal' : 'opacity-0'">
        <div class="mb-12">
            <span class="inline-block px-3 py-1 bg-primary/10 text-primary font-black text-xs uppercase tracking-[0.2em] rounded-full mb-4">Propietarios</span>
            <h2 class="text-3xl lg:text-4xl font-black text-text-primary mb-2 tracking-tight">Propietarios & Comunicación</h2>
            <p class="text-text-secondary font-medium text-lg">Transparencia total hacia los propietarios.</p>
        </div>
        <div class="grid md:grid-cols-3 gap-8">
            {{-- 7. Portal del Propietario --}}
            <div class="bg-white rounded-2xl border border-border-light p-8 hover:shadow-xl hover:border-primary/30 transition-all duration-500 group">
                <div class="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center mb-5 group-hover:bg-primary/20 transition-colors">
...
<section id="ia-facturas" class="py-20 lg:py-28 bg-gradient-to-br from-slate-900 via-primary-dark to-slate-900 relative overflow-hidden scroll-mt-28">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10"
         ...
         :class="shown ? 'animate-section-reveal' : 'opacity-0'">
        <div class="mb-12">
            <span class="inline-block px-3 py-1 bg-purple-500/20 text-purple-300 font-black text-xs uppercase tracking-[0.2em] rounded-full mb-4">Inteligencia Artificial</span>
            <h2 class="text-3xl lg:text-4xl font-black text-white mb-2 tracking-tight">Proveedores & Inteligencia Artificial</h2>
            <p class="text-white/70 font-medium text-lg">Gestión de proveedores potenciada con IA.</p>
        </div>
        <div class="grid md:grid-cols-3 gap-8">
            {{-- 4. Gestión de Proveedores --}}
            <div class="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 p-8 hover:bg-white/10 hover:border-white/20 transition-all duration-500 group">
                <div class="w-12 h-12 bg-secondary/20 rounded-xl flex items-center justify-center mb-5 group-hover:bg-secondary/30 transition-colors">
                ...
                <h3 class="text-lg font-black text-white mb-2">Gestión de Proveedores</h3>
                <p class="text-white/60 font-medium text-sm leading-relaxed mb-3">Alta de proveedores, contactos, facturas e historial completo en un solo lugar.</p>
                <p class="text-secondary font-bold text-xs italic">"Todos tus proveedores y sus facturas en un solo lugar"</p>
            </div>
            {{-- 5. IA Facturas --}}
            <div class="bg-white/5 backdrop-blur-sm rounded-2xl border border-purple-500/30 p-8 hover:bg-white/10 hover:border-purple-400/50 transition-all duration-500 group relative overflow-hidden">
                <div class="absolute top-3 right-3 bg-purple-500/30 text-purple-200 text-[10px] font-black px-2 py-1 rounded-full uppercase tracking-wider">IA</div>
                <div class="w-12 h-12 bg-purple-500/20 rounded-xl flex items-center justify-center mb-5 group-hover:bg-purple-500/30 transition-colors">
                    <svg class="w-6 h-6 text-purple-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"></path></svg>
                </div>
                <h3 class="text-lg font-black text-white mb-2">IA — Análisis de Facturas</h3>
                <p class="text-white/60 font-medium text-sm leading-relaxed mb-3">Cargá una foto de factura y la IA extrae montos, fechas y CUIT automáticamente. Impulsado por OpenAI.</p>
                <p class="text-purple-300 font-bold text-xs italic">"La IA trabaja, vos controlás"</p>
            </div>
            {{-- 6. Coeficientes --}}
            <div class="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 p-8 hover:bg-white/10 hover:border-white/20 transition-all duration-500 group">
                <div class="w-12 h-12 bg-secondary/20 rounded-xl flex items-center justify-center mb-5 group-hover:bg-secondary/30 transition-colors">
                ...
                <h3 class="text-lg font-black text-white mb-2">Coeficientes</h3>
                <p class="text-white/60 font-medium text-sm leading-relaxed mb-3">Configuración de coeficientes por unidad funcional para distribución justa de expensas.</p>
...
<section id="operaciones" class="py-20 lg:py-28 bg-white scroll-mt-28">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
         ...
         :class="shown ? 'animate-section-reveal' : 'opacity-0'">
        <div class="mb-12">
            <span class="inline-block px-3 py-1 bg-success/10 text-success font-black text-xs uppercase tracking-[0.2em] rounded-full mb-4">Operaciones</span>
            <h2 class="text-3xl lg:text-4xl font-black text-text-primary mb-2 tracking-tight">Operaciones & Control</h2>
            <p class="text-text-secondary font-medium text-lg">Las herramientas que hacen tu administración más eficiente.</p>
        </div>
        <div class="grid md:grid-cols-3 gap-8">
            {{-- 10. Multi-consorcio --}}
            <div class="bg-bg rounded-2xl border border-border-light p-8 hover:shadow-xl hover:border-success/30 transition-all duration-500 group">
...
<section class="py-16 bg-gradient-to-b from-slate-100 to-slate-50">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h3 class="text-2xl lg:text-3xl font-black text-text-primary mb-4 tracking-tight">¿Querés ver todo esto en acción?</h3>
        <p class="text-text-secondary font-medium text-lg mb-8 max-w-2xl mx-auto">Te mostramos cómo funciona cada módulo con tus propios datos. Sin compromiso.</p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="{{ route('demo') }}" class="btn-primary !py-4 !px-10 !text-base animate-cta-pulse">Solicitar Demo Gratuita</a>
            <a href="{{ route('contact') }}" class="btn-secondary !py-4 !px-10 !text-base">Hablá con un Asesor</a>
        </div>
        <p class="text-text-tertiary text-sm mt-6 font-medium">Sin compromiso · Setup en 48hs · Migración sin cargo</p>
    </div>
</section>
...
<section id="soporte" class="py-20 lg:py-28 bg-slate-50 scroll-mt-28">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
         ...
         :class="shown ? 'animate-section-reveal' : 'opacity-0'">
        <div class="mb-12">
            <span class="inline-block px-3 py-1 bg-primary/10 text-primary font-black text-xs uppercase tracking-[0.2em] rounded-full mb-4">Soporte</span>
            <h2 class="text-3xl lg:text-4xl font-black text-text-primary mb-2 tracking-tight">Soporte & Experiencia</h2>
            <p class="text-text-secondary font-medium text-lg">Nunca te sentís solo con CEOnline.</p>
        </div>
        <div class="grid md:grid-cols-3 gap-8">
            {{-- 13. Chat Soporte --}}
            <div class="bg-white rounded-2xl border border-border-light p-8 hover:shadow-xl hover:border-primary/30 transition-all duration-500 group">
...
{{-- Próximamente — bg-white --}}
<section class="py-20 lg:py-28 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
         x-data="{ shown: false }" x-intersect.once="shown = true"
         :class="shown ? 'animate-section-reveal' : 'opacity-0'">
        <div class="text-center mb-12">
            <span class="inline-flex items-center gap-2 px-4 py-2 bg-warning/10 text-warning rounded-full text-xs font-black uppercase tracking-widest">
                Próximamente
            </span>
            <h2 class="text-3xl lg:text-4xl font-black text-text-primary mt-6 tracking-tight">Features en desarrollo</h2>
            <p class="text-text-secondary font-medium mt-3 text-lg">El roadmap más ambicioso del mercado — y vos ya vas a estar adentro cuando salgan.</p>
        </div>
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="flex items-start gap-3 p-4 bg-slate-50 rounded-xl border border-border-light hover:shadow-md hover:border-warning/30 transition-all duration-300">
                <span class="w-1.5 h-1.5 bg-warning rounded-full mt-2 shrink-0"></span>
                <div>
