    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div class="text-center max-w-4xl mx-auto mb-12 lg:mb-16">
            <h2 class="text-2xl sm:text-3xl lg:text-4xl font-black text-text-primary leading-[1.1] tracking-tight">
                Si tu día arranca apagando incendios, no es falta de esfuerzo: es falta de sistema.
            </h2>
            <p class="mt-5 text-lg text-text-secondary font-medium leading-relaxed">
                Estas fricciones se repiten mes a mes. Elegí una y mirá cómo impacta en tu operación diaria.
            </p>
        </div>
        ...
        <div class="rounded-3xl border border-border-light bg-white shadow-[0_24px_70px_-40px_rgba(15,23,42,0.45)] overflow-hidden">
            <div class="grid lg:grid-cols-12">
                ...
                <aside class="lg:col-span-5 bg-gradient-to-b from-slate-50 to-white border-b lg:border-b-0 lg:border-r border-border-light p-5 sm:p-7 lg:p-8">
                    <p class="text-xs font-black uppercase tracking-[0.15em] text-slate-500 mb-4">Situaciones típicas</p>
                    ...
                    <div class="space-y-3">
                        <button type="button" @click="choose(0)" class="diagnostic-item w-full text-left rounded-2xl p-4 transition-all duration-300"
                            ...
                            <p class="mt-2 text-sm text-text-secondary">Correcciones de último momento, cálculos manuales y reclamos por diferencias.</p>
                        ...
                        <button type="button" @click="choose(1)" class="diagnostic-item w-full text-left rounded-2xl p-4 transition-all duration-300"
                            ...
                            <div class="flex items-start justify-between gap-4">
                                <h3 class="text-base sm:text-lg font-black tracking-tight" :class="active === 1 ? 'text-primary-dark' : 'text-text-primary'">Mensajes repetidos todo el día</h3>
                        ...
                        <button type="button" @click="choose(3)" class="diagnostic-item w-full text-left rounded-2xl p-4 transition-all duration-300"
                            ...
                            <div class="flex items-start justify-between gap-4">
                                <h3 class="text-base sm:text-lg font-black tracking-tight" :class="active === 3 ? 'text-primary-dark' : 'text-text-primary'">Información partida en varios lugares</h3>
                                <span class="text-[11px] font-black uppercase tracking-[0.14em]" :class="active === 3 ? 'text-primary' : 'text-slate-400'">04</span>
                            </div>
                            <p class="mt-2 text-sm text-text-secondary">Planillas, chats y archivos sueltos: buscar datos frena cada decisión.</p>
                ...
                <div class="lg:col-span-7 p-5 sm:p-7 lg:p-8 bg-white">
                    <div class="relative" style="min-height: 480px;">
                        <div x-show="active === 0"
                            ...
                            <p class="text-text-secondary font-medium mb-5">Automatizá cálculos de expensas y evitá volver a empezar cuando aparece una diferencia de último minuto.</p>
                        ...
                        <div x-show="active === 1"
                            ...
                            <h3 class="text-2xl lg:text-3xl font-black tracking-tight text-text-primary mb-3">Canal único para propietarios</h3>
                        ...
                        <div x-show="active === 2"
                            ...
                            <p class="text-text-secondary font-medium mb-5">Procesá facturas de proveedores en segundos con extracción automática de datos clave.</p>
                            <div class="rounded-2xl border border-border-light overflow-hidden">
                        ...
                        <div x-show="active === 3"
                            ...
                            <h3 class="text-2xl lg:text-3xl font-black tracking-tight text-text-primary mb-3">Visión completa de toda tu cartera</h3>
                            <p class="text-text-secondary font-medium mb-5">Concentrá documentos, comunicaciones y métricas en un solo panel para decidir más rápido.</p>
                            <div class="rounded-2xl border border-border-light overflow-hidden">
