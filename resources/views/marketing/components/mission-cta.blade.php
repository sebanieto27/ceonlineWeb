...
<section class="bg-brand-celeste relative mission-cta-section pt-32 pb-32">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center mt-12 md:mt-24">
        ...
        <div class="inline-flex flex-wrap justify-center gap-2 mb-12 p-1.5 bg-white/10 backdrop-blur-md rounded-full border border-white/20 animate-fade-in text-white/90">
            <span class="px-5 py-2 text-xs font-bold uppercase tracking-widest bg-white/20 rounded-full shadow-sm">Conocimiento</span>
            <span class="px-5 py-2 text-xs font-bold uppercase tracking-widest hover:bg-white/10 rounded-full transition-all cursor-pointer">Personas</span>
            <span class="px-5 py-2 text-xs font-bold uppercase tracking-widest hover:bg-white/10 rounded-full transition-all cursor-pointer">Proceso</span>
            <span class="px-5 py-2 text-xs font-bold uppercase tracking-widest hover:bg-white/10 rounded-full transition-all cursor-pointer">Plataforma</span>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-12 lg:gap-24 mb-32 max-w-4xl mx-auto">
            ...
            <div x-data="counter" x-intersect.once="start" data-target="200" data-suffix="+" class="text-center group">
                ...
                <p class="text-white/80 font-bold text-xs lg:text-sm uppercase tracking-[0.3em]">Consorcios gestionados</p>
            </div>
            {{-- Stat 2 --}}
            <div x-data="counter" x-intersect.once="start" data-target="42000" data-suffix="+" class="text-center group">
                ...
                <p class="text-white/80 font-bold text-xs lg:text-sm uppercase tracking-[0.3em]">Propietarios</p>
            </div>
        </div>
        ...
        <div class="pt-24 border-t border-white/20 max-w-5xl mx-auto animate-fade-in-up delay-300">
            ...
            <p class="text-white/90 text-lg lg:text-2xl mb-12 max-w-2xl mx-auto font-medium leading-relaxed">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center px-4">
                ...
                <a href="{{ route('demo') }}" class="w-full sm:w-auto px-10 py-5 bg-transparent border-2 border-white/50 text-white font-black rounded-lg text-lg lg:text-xl hover:bg-white/10 transition-all tracking-wide">
                    SOLICITAR DEMO
                </a>
            </div>
        </div>
