...
@section('content')
<section class="pt-40 pb-32 lg:pt-56 lg:pb-48 gradient-hero gradient-mesh relative overflow-hidden">
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-2xl mx-auto">
            <a href="{{ route('features') }}" class="bg-white rounded-xl border border-border-light p-4 hover:shadow-xl hover:border-primary/30 transition-all duration-500 group text-center">
                <div class="text-2xl mb-2">⚡</div>
                <span class="text-sm font-bold text-text-primary group-hover:text-primary transition-colors">Funciones</span>
            </a>
            <a href="{{ route('solutions') }}" class="bg-white rounded-xl border border-border-light p-4 hover:shadow-xl hover:border-primary/30 transition-all duration-500 group text-center">
                <div class="text-2xl mb-2">💡</div>
                <span class="text-sm font-bold text-text-primary group-hover:text-primary transition-colors">Soluciones</span>
            </a>
            <a href="{{ route('blog.index') }}" class="bg-white rounded-xl border border-border-light p-4 hover:shadow-xl hover:border-primary/30 transition-all duration-500 group text-center">
                <div class="text-2xl mb-2">📝</div>
                <span class="text-sm font-bold text-text-primary group-hover:text-primary transition-colors">Blog</span>
            </a>
            <a href="{{ route('demo') }}" class="bg-white rounded-xl border border-border-light p-4 hover:shadow-xl hover:border-primary/30 transition-all duration-500 group text-center">
                <div class="text-2xl mb-2">🚀</div>
